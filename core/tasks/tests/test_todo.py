...
from tasks.models import Tasks , Done
...
@pytest.fixture
def create_user():
    user_obj=User.objects.create_user(email='test@test.com' , password='@a12345678',is_verified=True)
    return user_obj
...
class TestTodo:
    ...
    def test_done_a_task_successfuly(self,create_user,create_task , api_client):
        user=create_user
        client=api_client
